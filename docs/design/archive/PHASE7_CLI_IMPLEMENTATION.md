...
1. Add children to workstation config
1. List children in workstation config
1. Show hierarchy (compact)
1. Create workspace config with git repos
1. List children in workspace config
1. Show full hierarchy with validation
1. Remove child from workstation config
1. Final hierarchy after removal
