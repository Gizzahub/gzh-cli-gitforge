...
const (
	...
	// WorkspaceScanned is for workspace configs generated by directory scan.
	WorkspaceScanned TemplateName = "workspace-scanned.yaml"
...
type ScannedRepoData struct {
	...
	Branch            string            // Current branch name (optional)
}
